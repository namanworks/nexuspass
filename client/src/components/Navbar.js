      ...
      <div className="hidden md:flex items-center gap-6">
        {user ? (
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition-colors shadow-sm"
            >
              Sign up
            </Link>
          </div>
          ...
          {user ? (
            <>
              ...
              {user.isAdmin && (
                <Link
                  href="/verify"
                  className="p-2 text-accent hover:bg-secondary rounded-md"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Scanner (Admin)
                </Link>
            ...
            <>
              ...
              <Link
                href="/register"
                className="p-2 bg-primary text-primary-foreground rounded-md text-center"
                onClick={() => setIsMenuOpen(false)}
              >
                Sign up
              </Link>
